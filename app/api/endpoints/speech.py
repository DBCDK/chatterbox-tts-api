...
def resolve_voice_path_and_language(voice_name: Optional[str]) -> tuple[str, str]:
    ...
    if not voice_name:
        return Config.VOICE_SAMPLE_PATH, default_language
    ...
    return voice_path, (voice_language or default_language)
...
def validate_language_for_generation(language_id: Optional[str]) -> Optional[str]:
    """Validate language selection against the loaded model configuration."""
...
async def text_to_speech(request: TTSRequest):
    ...
    language_id = validate_language_for_generation(language_id)
