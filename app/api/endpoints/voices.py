...
from app.core.tts_model import get_supported_languages, is_multilingual
...
def _current_supported_languages() -> dict[str, str]:
...
async def get_supported_languages_endpoint():
    ...
    try:
        supported_langs = _current_supported_languages()
        languages = [
...
async def get_default_voice():
    ...
    try:
        ...
        raise HTTPException(
            ...
            detail={
                "error": {
                    "message": f"Failed to get default voice: {str(e)}",
                    "type": "default_voice_error",
                }
            },
        )
...
async def set_default_voice(
    voice_name: str = Form(
        ...,
        description="Name of the voice to set as default",
        min_length=1,
        max_length=100,
    ),
):
    ...
    try:
        ...
        if not voice_lib.set_default_voice(voice_name):
            raise HTTPException(
                ...
                detail={
                    "error": {
                        "message": f"Voice '{voice_name}' not found in voice library",
        ...
        raise HTTPException(
            ...
            detail={
                "error": {
                    "message": f"Failed to set default voice: {str(e)}",
                    "type": "default_voice_error",
                }
            },
        )
...
async def reset_default_voice():
    ...
    try:
        ...
        raise HTTPException(
            ...
            detail={
                "error": {
                    "message": f"Failed to reset default voice: {str(e)}",
                    "type": "default_voice_error",
                }
            },
        )
...
async def upload_voice(
    voice_name: str = Form(
        ...,
        description="Name for the voice (used in API calls)",
        min_length=1,
        max_length=100,
    ),
    ...
    language: str = Form(
        "en",
        description="Language code for the voice (e.g., 'en', 'fr', 'es')",
        min_length=2,
        max_length=5,
    ),
):
    ...
    try:
        ...
        metadata = voice_lib.add_voice(
            voice_name, file_content, voice_file.filename, language
        )
...
async def download_voice(voice_name: str):
    ...
    try:
        ...
        return FileResponse(voice_path, filename=filename, media_type="audio/wav")
    except HTTPException:
        raise
    except Exception as e:
        raise HTTPException(
            ...
            detail={
                "error": {
                    "message": f"Failed to download voice: {str(e)}",
                    "type": "voice_library_error",
                }
            },
        )
...
async def rename_voice(
    voice_name: str,
    new_name: str = Form(
        ..., description="New name for the voice", min_length=1, max_length=100
    ),
):
    ...
    try:
        ...
        raise HTTPException(
            ...
            detail={
                "error": {
                    "message": f"Failed to rename voice: {str(e)}",
                    "type": "voice_library_error",
                }
            },
        )
...
async def delete_voice(voice_name: str):
    ...
    try:
        ...
        return {"message": "Voice deleted successfully", "voice_name": voice_name}
...
async def add_voice_alias(
    voice_name: str,
    alias: str = Form(
        ..., description="The alias to add", min_length=1, max_length=100
    ),
):
    ...
    try:
        ...
        if not success:
            raise HTTPException(
                ...
                detail={
                    "error": {
                        "message": f"Voice '{voice_name}' or alias '{alias}' not found",
                        "type": "voice_not_found_error",
                    }
                },
            )
        ...
        raise HTTPException(
            ...
            detail={
                "error": {
                    "message": f"Failed to remove alias: {str(e)}",
                    "type": "voice_library_error",
                }
            },
        )
...
async def list_voice_aliases(voice_name: str):
    ...
    try:
        ...
        return {"voice_name": voice_name, "aliases": aliases, "count": len(aliases)}
...
async def list_all_voice_names():
    ...
    try:
        ...
        return {"voice_names": all_names, "count": len(all_names)}
        ...
        raise HTTPException(
            ...
            detail={
                "error": {
                    "message": f"Failed to list voice names: {str(e)}",
                    "type": "voice_library_error",
                }
            },
        )
...
async def cleanup_voices():
    ...
    try:
        ...
        raise HTTPException(
            ...
            detail={
                "error": {
                    "message": f"Failed to cleanup voices: {str(e)}",
                    "type": "voice_library_error",
                }
            },
        )
